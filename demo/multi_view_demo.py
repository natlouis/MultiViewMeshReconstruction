...
from shapenet.data.mesh_vox_modified import MeshVoxDataset
from shapenet.modeling.mesh_arch_modified import VoxMeshHead
...
if __name__ == "__main__":
    ...
    item = dataset[idx] #(img, verts, faces, points, normals, voxels, Ps, id_strs, _imgs)
    imgs = item[-1]
    imgs = imgs.unsqueeze(0)
    print(imgs.shape)
    id_str = item[-2]
    prediction = demo.run_on_image(imgs, id_str)
